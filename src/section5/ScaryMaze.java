...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("womanScream.wav"));
		...
		showScaryImage("pennywise.jpg");
	}

	private void showScaryImage(String imageName) {
		try {
			maze = ImageIO.read(getClass().getResource(imageName));
			BufferedImage outputImage = new BufferedImage(500,500,maze.getType());
			maze = outputImage;
		} catch (Exception e) {
