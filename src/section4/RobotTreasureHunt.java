...
public class RobotTreasureHunt implements KeyEventDispatcher {
	...
	private void spaceBarWasPressed() {
		...
		if (robotXlocation == 720 && robotYlocation == 400)
			JOptionPane.showMessageDialog(null, "You are on the little girl! Go to the pirate hat.");
	}
	...
	{
				JOptionPane.showMessageDialog(null, "You are on the pirate hat! Go take a water break.")
